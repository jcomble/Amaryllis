...
public class FamiliersHealer {
	...
	public String heal(ResultSet res) throws SQLException {
		...
		for (int iterator = 0; iterator < 20; iterator++) {
			...
			StatsReader stats = new StatsReader(iterator + 1, EXP_familier_i, VERSION_familier_i, PV_familier_i, PM_familier_i);
			...
			result_request += "expf" + String.valueOf(iterator + 1) + " = " + String.valueOf(EXP_familier_i) + ", ";
			result_request += "pvf" + String.valueOf(iterator + 1) + " = " + String.valueOf(PV_familier_i) + ", ";
			result_request += "pmf" + String.valueOf(iterator + 1) + " = " + String.valueOf(PM_familier_i) + ", ";
			result_request += "versionf" + String.valueOf(iterator + 1) + " = " + String.valueOf(VERSION_familier_i);
			if (iterator != 19) {
				result_request += ", ";
			}
		}
